...
from calkowanie import Simulation_frog

a = Simulation_frog(0.01,0.001,[{'m':0.1, 'init_pos':np.array([2,0]), 'init_momentum':np.array([0,0.1])}, {'m':500, 'init_pos':np.array([0,0]), 'init_momentum':np.array([0,0])}])
print(a)
body_1x = []
body_1y = []
body_2x = []
...
for _ in range(30000):
    ...
    speed = np.linalg.norm(a.bodies[0].half_speed + a.bodies[0].new_speed(a.F(a.bodies[0])))/2
