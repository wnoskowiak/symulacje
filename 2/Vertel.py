...
from calkowanie import Simulation_vertel

a = Simulation_vertel(0.01,0.001,[{'m':0.1, 'init_pos':np.array([2,0]), 'init_momentum':np.array([0,0.1])}, {'m':500, 'init_pos':np.array([0,0]), 'init_momentum':np.array([0,0])}])
print(a)
body_1x = []
body_1y = []
body_2x = []
...
for _ in range(30000):
    ...
    speed = np.linalg.norm(a.bodies[0].pos - a.bodies[0].last_pos)/a.dt
